...
#define STRING_CONFIG_H_AUTHOR "(Stephen, Eaton)" // Who made the changes.
...
// default 424 per unit for Felix 2.0/3.0: 0.00249mm x/y rounding error with 3mm pitch HTD belt and 14 tooth pulleys. 0 Z error.
/**
 * Default Settings
 *
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -17, 29, 0 }
